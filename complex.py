def Insert_Numbers():
    user_komplex1 = input('Введите первое число: ')
    user_komplex2 = input('Введите второе число: ')
...
def Repeat_Or_No():
    ...
    while user_choice != 'Y' or user_choice != 'N':
        user_choice = input('Вы хотите продолжить работать с комплексными числами? (Y or N)')
        if user_choice == 'N':
            return False
        elif user_choice == 'Y':
            return True
